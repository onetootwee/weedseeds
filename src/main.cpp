...
int64 nChainStartTime = 1400560000; ////1395310000;
...
const string strMessageMagic = "WeedSeeds Signed Message:\n";
...
const int DAILY_BLOCKCOUNT =  1440;	    // 1440 * 3
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    else if(pindexBest->nHeight < (8 * DAILY_BLOCKCOUNT))
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in WeedSeeds
    bool fStrictPayToScriptHash = true; // Always active in WeedSeeds
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WeedSeeds", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Free the seeds";
        CTransaction txNew;
 	  ...
 	  if (false  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x62740b3700d3558fb0752a8053323de7c672845a74515241e4245f75720970a9"));
